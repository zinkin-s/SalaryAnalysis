...
if selector == 'сельское хозяйство, охота и лесное хозяйство':
    ...
    """
     ...
     text_tab1 = """
        С 2000 года наблюдается устойчивый рост номинальных и реальных заработных плат. Уровень зарплат сравним
        со средней по экономике. После 2014 года происходит резкое увеличение зарплаты по отрасли.
    """
     text_tab2 = """
        С 2000 по 2008 индекс реальных заработных плат выше или равен индекса потребительских цен,
        т.е. зарплаты растут быстрее чем потребительские цены. Падение реальных заработных плат в 2008-2010 гг.
    ...
    text_tab1 = """
        С 2000 года наблюдается устойчивый рост номинальных и реальных заработных плат. Уровень заработных плат
        одного порядка со средней заработной плате по экономике.
    """
    text_tab2 = """
        С 2000 по 2008 индекс реальных заработных плат выше или равен индекса потребительских цен,
        т.е. зарплаты растут быстрее чем потребительские цены. Падение реальных заработных плат в 2008-2010 гг.
